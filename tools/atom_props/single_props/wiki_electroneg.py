...
res = requests.get("https://en.wikipedia.org/wiki/Electronegativities_of_the_elements_(data_page)")
...
#        print(sdf)
    #print(soup.prettify())
    #break
df.drop(columns=[c for c in df.columns if c not in ["use","Electronegativity"]],inplace=True)
