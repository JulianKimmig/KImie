...
from KImie.utils.mol.properties import has_confomers, assert_conformers
...
for s, d in sheets.items():
    full_code = "from KImie.featurizer._molecule_featurizer import MoleculeFeaturizer,SingleValueMoleculeFeaturizer, FixedSizeMoleculeFeaturizer, VarSizeMoleculeFeaturizer\n"
