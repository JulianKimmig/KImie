...
class Featurizer:
    ...
    def prepend_postfeaturizer(
        self, pre_featurizer: Callable[["Featurizer", Any], Any], name: str
    ):
    ...
    def postfeaturize(
        self, to_featurize: Any, ignored_postfeaturizers: List[str] = None
    ):
    ...
    def __call__(
        self, to_featurize, ignored_prefeaturizers=None, ignored_postfeaturizers=None
    ):
        if ignored_prefeaturizers is None:
            ignored_prefeaturizers = []
        if ignored_postfeaturizers is None:
        ...
        to_featurize = self.prefeaturize(
            to_featurize, ignored_prefeaturizers=ignored_prefeaturizers
        )
